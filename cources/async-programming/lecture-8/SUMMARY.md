...
two counters and two threads on which the increment method was running
were created.
...
take into account the changes other threads did because they haven't wait for
the end of operation on the other threads and had been working with
outdated data which leads to lost operations.